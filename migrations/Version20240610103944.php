 ...
 */
final class Version20240610103944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE review DROP id, CHANGE review_id review_id INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (review_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE review ADD id INT NOT NULL, CHANGE review_id review_id INT NOT NULL');
